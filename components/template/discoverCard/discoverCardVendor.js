      ...
      <div className="w-full font-slussen">
        <div className="flex justify-between text-left mb-[8px] sm:mb-[16px] items-center ">
          <p className=" text-[20px] sm:text-[24px] text-[#0E0D0D] font-bold line-clamp-1">
            James John & Associates Inc Photographer Associates Inc Photographer
            Associates Inc Photographer{" "}
          </p>

          <div className="flex ">
            <p className="text-[#0E0D0D] text-[16px] font-normal btn-p">5.0</p>
...
export default DiscoverCardVendor;
